...
function initChatSystem() {
    // FIX: Changed "messagesList" to "msgContainer" to match HTML ID
    const chatContainer = document.getElementById("msgContainer");
    ...
    async function fetchMessages() {
        try {
            ...
            // Only re-render if there are new messages or first load
